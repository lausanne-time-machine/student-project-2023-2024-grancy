...
// Use fetch for JSON files instead of import assertions
...
async function initializeApp() {
  try {
    ...
    const geojson_1923 = await loadGeoJSON('./directory1923.geojson');
    const geojson_1951 = await loadGeoJSON('./directory1951.geojson');
